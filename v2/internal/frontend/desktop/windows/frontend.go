...
import (
	...
	wailsruntime "github.com/cllsm/wails-win7/v2/internal/frontend/runtime"
	...
	"github.com/cllsm/wails-win7/v2/pkg/options/windows"
)
...
func (f *Frontend) Run(ctx context.Context) error {
	...
	mainWindow.OnSize().Bind(func(arg *winc.Event) {
		if f.frontendOptions.Frameless {
			...
			// depends on the content in the WebView, see https://github.com/cllsm/wails-win7/issues/1319
