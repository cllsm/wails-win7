...
import (
	...
	"github.com/cllsm/wails-win7/v2/internal/github"
)
...
func updateToVersion(targetVersion *github.SemanticVersion, force bool, currentVersion string) error {
	...
	sout, serr, err := shell.RunCommand(homeDir, "go", "install", "github.com/cllsm/wails-win7/v2/cmd/wails@"+desiredVersion)
	if err != nil {
	...
	pterm.Println(color.Green("  require github.com/cllsm/wails-win7/v2 " + desiredVersion))
