...
- [GitHub](https://github.com/cllsm/wails-win7) - バグの報告や機能のリクエストは、GitHubのイシューで行ってください。 その際、各リポジトリのイシューテンプレートで指定されているルールを順守してください。
...
それぞれの貢献方法について、各セクションで説明します。 まず初めに、[Contributing to Wails](https://github.com/cllsm/wails-win7/discussions/1520)ディスカッションで自己紹介をしましょう。
