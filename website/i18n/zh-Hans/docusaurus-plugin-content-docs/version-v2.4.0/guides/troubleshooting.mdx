...
致谢：https://github.com/cllsm/wails-win7/issues/1186
...
来源：https://github.com/cllsm/wails-win7/issues/1233
...
来源：https://github.com/cllsm/wails-win7/discussions/1512

## 运行 `wails dev` 出现 `too many open files` 错误

默认情况下，macOS 最多只能打开 256 个文件。 这会影响 `wails dev` 命令 可以通过在终端中运行：`ulimit -n 1024` 来增加此限制。

FSNotify 正在 [寻求转移到苹果](https://github.com/fsnotify/fsnotify/issues/11)。 如果这不能很快完成，我们将创建自己的实现，在 [此处](https://github.com/cllsm/wails-win7/issues/1733) 跟踪。
...
来源：https://github.com/cllsm/wails-win7/issues/1806 和 https://github.com/cllsm/wails-win7/issues/1140#issuecomment-1290446496
