...
Reference: https://github.com/cllsm/wails-win7/issues/1504#issuecomment-1174317433
...
Credit: https://github.com/cllsm/wails-win7/issues/1186
...
```
"https://proxy.golang.org/github.com/cllsm/wails-win7/cmd/wails/@v/list": dial tcp 172.217.163.49:443: connectex: A connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond.
```
...
Source: https://github.com/cllsm/wails-win7/issues/1233
...
Source: https://github.com/cllsm/wails-win7/discussions/1512
...
FSNotify is [looking to move to Apple's fsevents](https://github.com/fsnotify/fsnotify/issues/11) for Mac. If this isn't completed soon, we will create our own implementation, tracked [here](https://github.com/cllsm/wails-win7/issues/1733).
...
In file included from ../../pkg/mod/github.com/cllsm/wails-win7/v2@v2.0.0-beta.44.2/internal/frontend/desktop/darwin/callbacks.go:9:
...
Sources: https://github.com/cllsm/wails-win7/issues/1806 and https://github.com/cllsm/wails-win7/issues/1140#issuecomment-1290446496
